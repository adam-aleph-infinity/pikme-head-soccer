...
const OUT = process.env.SHOT_OUT, CDP = 9511;
mkdirSync(OUT, { recursive: true });
const ch=spawn('/Applications/Google Chrome.app/Contents/MacOS/Google Chrome',[`--remote-debugging-port=${CDP}`,'--headless=new','--no-first-run','--mute-audio','--hide-scrollbars',`--user-data-dir=${OUT}/fprof`,'about:blank'],{stdio:'ignore'});
